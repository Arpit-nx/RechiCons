import ProjectTemplate from "../component/individual_project_source/project_template.jsx";
...
const projectData = {
  hero: {
    ...
    images: [heroImg],                     // array preferred by normalizeImages
  },
  ...
  floorPlan: {
    ...
    images: [floorPlanImg],                // array preferred
    configurations: [
  ...
  // Optional: force a specific order (otherwise default order is used)
  // sectionsOrder: ["vision", "floorPlan", "residences", "amenities", "specifications", "connectivity", "projectView"],
};
